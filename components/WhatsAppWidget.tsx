  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col items-start gap-3">
      ...
      {open && (
        <div className="flex flex-col gap-2 animate-fade-in-up">
          ...
          <a
            ...
            onMouseEnter={e => {
              e.currentTarget.style.borderColor = "rgba(0,101,255,0.4)";
              e.currentTarget.style.background = "rgba(0,101,255,0.08)";
            }}
            onMouseLeave={e => {
              e.currentTarget.style.borderColor = "#EDEDED";
              e.currentTarget.style.background = "#FFFFFF";
          ...
          >
            <Mail size={14} style={{ color: "#0065ff" }} />
      ...
      <button
        ...
        style={{
          background: open ? '#141414' : 'linear-gradient(135deg, #0065ff, #0047f0)',
          borderColor: open ? '#141414' : 'rgba(0,101,255,0.1)'
        }}
