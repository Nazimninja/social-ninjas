...
const SocialProofBanner: React.FC = () => {
  return (
    <div className="fixed top-0 left-0 right-0 z-[60] h-9 bg-white border-b border-neutral-200 flex items-center justify-center overflow-hidden">
        ...
        {[...Array(4)].map((_, i) => (
            <React.Fragment key={i}>
                <div className="flex items-center gap-2 opacity-80 hover:opacity-100 transition-opacity">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-700">Trusted by 100+ Premium Brands</span>
                </div>
                <div className="flex items-center gap-2 opacity-80 hover:opacity-100 transition-opacity">
                    <TrendingUp size={10} className="text-brand-primary" />
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-700">$50M+ Revenue Generated</span>
                </div>
                <div className="flex items-center gap-2 opacity-80 hover:opacity-100 transition-opacity">
                    <ShieldCheck size={10} className="text-brand-primary" />
                    <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-700">Official Meta & Google Partner</span>
                </div>
            </React.Fragment>
        ))}
      </div>
