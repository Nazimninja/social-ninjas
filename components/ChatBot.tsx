  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 z-50 p-4 rounded-full shadow-[0_4px_24px_rgba(31,75,153,0.25)] transition-all duration-300 group hover:scale-110 ${isOpen ? 'opacity-0 pointer-events-none scale-0' : 'opacity-100 scale-100 bg-[#1F4B99] text-white hover:bg-[#153880]'}`}
        ...
        <div className="p-4 bg-white/80 backdrop-blur-md border-t border-neutral-200 shrink-0 safe-area-bottom">
          ...
          <div className="relative group/input">
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2.5 md:p-2 bg-[#1F4B99] text-white rounded-full hover:bg-[#153880] transition-all duration-300 disabled:opacity-0 disabled:scale-75 shadow-lg hover:scale-105 active:scale-95 touch-manipulation"
            >
