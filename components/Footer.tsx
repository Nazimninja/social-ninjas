        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="space-y-6 md:col-span-2">
            <Link to="/" style={{display:'flex',alignItems:'center',gap:10,textDecoration:'none'}}>
              <div style={{width:34,height:34,borderRadius:'50%',overflow:'hidden',border:'1.5px solid rgba(79,158,255,0.35)',boxShadow:'0 0 14px rgba(79,158,255,0.18)',background:'#08101f'}}>
              ...
              <span style={{fontFamily:"'DM Sans',system-ui",fontSize:17,fontWeight:600,letterSpacing:'-.3px',color:'rgba(255,255,255,0.95)'}}>Social<span style={{color:'#4f9eff'}}>Ninja's</span>.</span>
            </Link>
