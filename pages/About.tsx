...
const About: React.FC = () => {
   ...
   return (
      <div className="min-h-screen bg-[#020617] overflow-hidden selection:bg-brand-primary selection:text-black font-sans">
         <SEO
            title="About Social Ninja's | Premium Digital Growth Partner"
            ...
            keywords="growth agency team, performance marketing specialists, brand scaling strategy, tactical digital agency, marketing ROI experts, global marketing agency, digital agency"
         />
                        ...
                        <div className="relative aspect-square max-w-[500px] mx-auto">
                           ...
                           <div className="absolute top-1/2 left-1/4 -translate-y-1/2 -translate-x-1/2">
                              <div className="relative group cursor-pointer">
                                 ...
                                 <div className="absolute top-6 left-1/2 -translate-x-1/2 text-center whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                                    <span className="text-white font-bold text-xs bg-brand-dark/80 px-2 py-1 rounded border border-brand-primary/30">GLOBAL HQ</span>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div className="absolute top-1/3 right-1/4 -translate-y-1/2 translate-x-1/2">
                              <div className="relative group cursor-pointer">
                                 ...
                                 <div className="absolute top-6 left-1/2 -translate-x-1/2 text-center whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
                                    <span className="text-white font-bold text-xs bg-brand-dark/80 px-2 py-1 rounded border border-brand-secondary/30">REGIONAL HUBS</span>
                                 </div>
                              </div>
                           </div>
