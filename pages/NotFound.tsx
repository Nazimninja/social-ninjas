...
const NotFound: React.FC = () => {
    return (
        <div className="page-wrap" style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"80px 24px",minHeight:"100vh"}}>
            ...
            <div style={{width:96,height:96,background:"rgba(31,75,153,0.1)",border:"1px solid rgba(31,75,153,0.2)",borderRadius:"50%",display:"flex",alignItems:"center",justifyContent:"center",color:"#1F4B99",marginBottom:32,animation:"pulse 3s infinite"}}>
