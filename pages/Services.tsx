...
const services = [
  {
    icon:'🤖', title:'AI & Automation', color:'#4f9eff',
    ...
    <div className="page-bg" style={{fontFamily:"'DM Sans',system-ui,sans-serif"}}>
      ...
      <div style={{position:'relative',paddingTop:140,paddingBottom:88,overflow:'hidden',borderBottom:'1px solid rgba(255,255,255,0.07)'}}>
        ...
        <div style={{maxWidth:1100,margin:'0 auto',padding:'0 28px',position:'relative',zIndex:2,textAlign:'center'}}>
          ...
          <h1 className="reveal d1" style={{fontFamily:"'Instrument Serif',Georgia,serif",fontSize:'clamp(42px,6.5vw,84px)',fontWeight:400,letterSpacing:'-2px',lineHeight:1.02,marginBottom:20,color:'rgba(255,255,255,0.96)'}}>
            Growth services that<br/><em style={{color:'#4f9eff'}}>actually move the needle.</em>
          </h1>
          <p className="reveal d2" style={{fontSize:'clamp(15px,1.8vw,18px)',fontWeight:300,color:'rgba(255,255,255,0.5)',lineHeight:1.72,maxWidth:560,margin:'0 auto 40px'}}>
            Every service is built around one goal: measurable revenue. No vanity metrics, no fluff reports — just results.
          </p>
      ...
      <div style={{borderTop:'1px solid rgba(255,255,255,0.07)',padding:'88px 28px',background:'rgba(4,8,18,0.5)',position:'relative',zIndex:1}}>
        <div style={{maxWidth:1100,margin:'0 auto'}}>
          <div style={{textAlign:'center',marginBottom:60}}>
            ...
            <h2 className="reveal d1" style={{fontFamily:"'Instrument Serif',Georgia,serif",fontSize:'clamp(28px,4vw,48px)',fontWeight:400,letterSpacing:'-1px',color:'rgba(255,255,255,0.95)',lineHeight:1.1}}>From audit to <em>revenue</em> in 30 days.</h2>
          </div>
          <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:14}} className="four-cols">
            {[
              ...
              <div key={i} className={`glass-card reveal d${i+1}`} style={{padding:26,borderRadius:20}}>
                <div style={{fontFamily:"'JetBrains Mono',monospace",fontSize:32,fontWeight:500,color:'rgba(79,158,255,0.25)',lineHeight:1,marginBottom:16,letterSpacing:'-1px'}}>{p.n}</div>
        ...
        <div className="reveal" style={{background:'rgba(8,14,26,0.7)',backdropFilter:'blur(60px)',border:'1px solid rgba(255,255,255,0.09)',borderRadius:28,padding:'80px 48px',textAlign:'center',position:'relative',overflow:'hidden'}}>
          ...
          <div style={{position:'relative',zIndex:1}}>
            <h2 style={{fontFamily:"'Instrument Serif',Georgia,serif",fontSize:'clamp(28px,4.5vw,52px)',fontWeight:400,letterSpacing:'-1.5px',lineHeight:1.06,marginBottom:14,color:'rgba(255,255,255,0.96)'}}>
              Let's build your <em style={{color:'#4f9eff'}}>growth engine.</em>
            </h2>
      ...
      <style>{`@media(max-width:900px){.two-cols{grid-template-columns:1fr!important;}.four-cols{grid-template-columns:1fr 1fr!important;}} @media(max-width:640px){.four-cols{grid-template-columns:1fr!important;}}`}</style>
    </div>
  );
};
