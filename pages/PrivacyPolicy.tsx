    ...
    return (
        <div className="pt-24 pb-16 min-h-screen bg-white selection:bg-brand-primary selection:text-black">
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                {/* Header */}
                <div className="mb-16 border-b border-neutral-200 pb-10 animate-fade-in-up">
                    ...
                    <h1 className="font-display text-4xl md:text-5xl font-bold text-neutral-900 mb-4">Privacy Policy</h1>
                ...
                <div className="space-y-12 animate-fade-in-up" style={{ animationDelay: '100ms' }}>
                    ...
                    <section className="bg-neutral-50 border border-neutral-200 p-8 rounded-2xl">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h2 className="text-2xl font-bold text-neutral-900 font-display">1. Introduction</h2>
                        </div>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-neutral-900 mb-4 pl-4 border-l-2 border-brand-primary">2. Information We Collect</h2>
                        <div className="space-y-6">
                            <div>
                                <h3 className="text-neutral-900 font-bold mb-2">A. Personal Information</h3>
                                <p className="text-neutral-600 leading-relaxed">
                                    When you book a strategy call or submit a form, we collect:
                                </p>
                                <ul className="list-disc list-inside text-neutral-600 mt-2 ml-2">
                                    <li>Name, Email Address, Phone Number.</li>
                                    <li>Company Name, Job Title, and Revenue Details.</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="text-neutral-900 font-bold mb-2">B. Operational Data (For Clients)</h3>
                                <p className="text-neutral-600 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-neutral-900 mb-4 pl-4 border-l-2 border-brand-primary">3. How We Use Your Information</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-neutral-50 p-4 rounded-lg">
                                <h3 className="text-neutral-900 font-bold mb-2 text-sm">Service Execution</h3>
                                <p className="text-neutral-600 text-sm">Deploying ad campaigns, training custom AI agents, and automating lead follow-ups.</p>
                            </div>
                            <div className="bg-neutral-50 p-4 rounded-lg">
                                <h3 className="text-neutral-900 font-bold mb-2 text-sm">Communication</h3>
                                <p className="text-neutral-600 text-sm">Sending strategy updates, reports, and administrative notifications.</p>
                            </div>
                            <div className="bg-neutral-50 p-4 rounded-lg">
                                <h3 className="text-neutral-900 font-bold mb-2 text-sm">AI Training (Restricted)</h3>
                                <p className="text-neutral-600 text-sm">Your data is used to train <em>your specific</em> AI agents. We do NOT use your proprietary data to train public models.</p>
                            </div>
                            <div className="bg-neutral-50 p-4 rounded-lg">
                                <h3 className="text-neutral-900 font-bold mb-2 text-sm">Legal Compliance</h3>
                                <p className="text-neutral-600 text-sm">Fulfilling obligations under Indian and UAE tax and data laws.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    {/* 4. Tracking & Cookies */}
                    <section>
                        <h2 className="text-xl font-bold text-neutral-900 mb-4 pl-4 border-l-2 border-brand-primary">4. Cookies & Pixel Tracking</h2>
                    ...
                    {/* 5. Data Sharing */}
                    <section>
                        <h2 className="text-xl font-bold text-neutral-900 mb-4 pl-4 border-l-2 border-brand-primary">5. Data Sharing & Security</h2>
                        <p className="text-neutral-600 leading-relaxed mb-4">
                            <strong>We guard your data like a ninja.</strong> We do not sell your personal data. We only share data with:
                        </p>
                        <ul className="list-disc list-inside text-neutral-600 space-y-2 ml-2 mb-6">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-neutral-900 mb-4 pl-4 border-l-2 border-brand-primary">6. International Data Transfers</h2>
                        <p className="text-neutral-600 leading-relaxed">
                    ...
                    {/* 7. Your Rights */}
                    <section>
                        <h2 className="text-xl font-bold text-neutral-900 mb-4 pl-4 border-l-2 border-brand-primary">7. Your Rights</h2>
                    ...
                    <section className="bg-neutral-50 border border-neutral-200 p-8 rounded-2xl md:col-span-2 mt-12">
                        <div className="flex items-center gap-3 mb-6">
                            <Mail className="text-brand-primary" size={24} />
                            <h2 className="text-2xl font-bold text-neutral-900 font-display">Contact Us</h2>
                        </div>
                        ...
                        <div className="space-y-2">
                            <p className="text-neutral-900 font-bold">Social Ninja's (Data Compliance Officer)</p>
                            <a href="mailto:info@socialninjas.in" className="text-brand-primary hover:text-neutral-900 transition-colors block text-lg font-mono">
                    ...
                    {/* Link to Terms */}
                    <div className="bg-neutral-50 border border-neutral-200 p-6 rounded-2xl flex items-center justify-between flex-wrap gap-4">
                        <div>
                            <p className="text-neutral-900 font-bold mb-1">Also read our Terms of Service</p>
